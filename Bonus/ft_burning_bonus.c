...
int	ft_drowing(t_varstock *stock)
{
	...
	stock->r->z.y = fabs(2 * tmp_z * stock->r->z.y) + stock->r->c.y;
...
void	callburning(void)
{
	...
	mlx_hook(stock.win_ret, 2, 0, ft_burningkeybord, &stock);
